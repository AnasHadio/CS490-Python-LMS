...
<html>
  ...
  <header class="mainHeader">
      <h1 class="header">STUDENT LANDING PAGE</h1>
      <ul class="navLIST">
    ...
    <div class="container" id="takeExam">
      Take Exams<br>
    </div>
    <br><br>
    <div class="container" id="reviewExam">
      Review Exam<br>
    </div> 
      ...
      function displayExams(){
        ...
        .then(data => {
          ...
          for(let i = 0; i < examsToTake.length; i++){
            ...
            button.setAttribute("class", "examTakeButtons btn btn-success");
          ...
          for(let i = 0; i < examsTaken.length; i++){
            ...
            button = document.createElement("input")
            button.setAttribute("type", "button");
            button.setAttribute("class", "examReviewButtons btn btn-success");
